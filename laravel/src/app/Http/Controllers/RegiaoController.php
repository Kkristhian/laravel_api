...
class RegiaoController extends BaseController
{
    ...
    public function loadConsultaRegiao ()
    {
        return view("regiao.consulta_regiao", [ "regioes" => $this->regiao->todasRegioes() ]);
    }

    public function loadCadastraRegiao(){
        return view('regiao.cadastro_regiao', [
            'id' => $this->max() + 1
        ]);
    }
    public function loadAtualizaRegiao(){
        return view('regiao.cadastro_regiao', [
            'id' => $this->max() + 1
        ]);
    }
